class SettingsMenu {
    ...
    class controlsBackground {
        ...
        class ExtendedStatsHeader : PlayerTagsHeader {
            idc = -1;
            text = "Display Stats HUD";
            y = 0.58;
        };
    ...
    class controls {
        ...
        class HudStatsONOFF : PlayerTagsONOFF {
            idc = 2973;
            tooltip = "$STR_GUI_PlayerReveal";
            onCheckedChanged = "['hudstats',_this select 1] call life_fnc_s_onCheckedChange;";
            y = 0.58;
        };
